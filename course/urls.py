...
urlpatterns = [
    ...
    url(r'^dane_w_przestrzeni_k/([0-8])/$', views.k_space, name='k_space'),
    ...
    url(r'^rekonstrukcja_danych/([0-8])/$', views.reconstruction, name='reconstruction'),
    ...
    url(r'^obrazowanie_dyfuzji/([0-8])/$', views.diffusion, name='diffusion'),
    ...
    url(r'^profil/edit$', views.profile_edit, name='profile_edit'),
    url(r'^testy_wiedzy/$', views.quiz, name='quiz'),
    url(r'^testy_wiedzy/([0-9]+)/$', views.quiz_details, name='quiz_details'),
